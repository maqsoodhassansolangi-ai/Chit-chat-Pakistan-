...
function displayMessage(msg) {
    ...
    div.innerHTML = `
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:4px;">
            ...
            <span class="reply-btn">↩️ Reply</span>
            ${deleteBtn}
        </div>
        ${replyHTML}
        <span>${content}</span>
    ...
    `;
    div.querySelector('.reply-btn').addEventListener('click', () => startReply(msg));
...
function renderReactions(container, reactions) {
    ...
    if (reactions) {
        Object.entries(reactions).forEach(([emoji, uids]) => {
            ...
            pill.addEventListener('click', () => toggleReaction(container.dataset.msgkey, emoji));
    ...
    addBtn.textContent = '😊+';
    addBtn.addEventListener('click', (e) => openReactionPicker(e, container.dataset.msgkey));
